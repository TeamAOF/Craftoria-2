...
* Changed seasons debug default keybind `AK`
* Added default options for volume, fps & vsync `AK`

### Added Mods ✅

- [ComplementaryUnbound](https://www.curseforge.com/minecraft/shaders/complementary-unbound)
- [punchy](https://www.curseforge.com/minecraft/mc-mods/punchy)
- [starcatcher](https://www.curseforge.com/minecraft/mc-mods/starcatcher)

### Bug Fixes 🪲

* Overlapping menu buttons `SubordinalBlue`

# Craftoria | v0.1.0

_Neoforge_ 26.1.2.42 | _[Mod Updates](https://github.com/TeamAOF/Craftoria-2/blob/main/changelogs/changelog_mods_0.1.0.md)_ | _[Modlist](https://github.com/TeamAOF/Craftoria-2/blob/main/changelogs/modlist_0.1.0.md)_
